...
public class Status extends MetaDataSystem implements Comparable<Status> {

	public static final TableSchema<Status> STATUS_TABLE_SCHEMA = TableSchema.fromClass(Status.class);
